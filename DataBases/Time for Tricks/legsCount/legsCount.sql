...
You want to calculate the total number of legs in the meadow. Given the 
table creatures, build a new table that only contains one column 
summary_legs and has only one row with the total number of legs 
that you can see.
...
summary_legs
12
There are 2 humans, 1 cat, and 1 dog, so there are 2 * 2 + 1 * 4 + 1 * 4 = 12 
legs in total.